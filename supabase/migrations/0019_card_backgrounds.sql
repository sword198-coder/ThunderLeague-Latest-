...
INSERT INTO public.card_backgrounds (id, name, gradient_from, gradient_via, gradient_to, price) VALUES
  ...
  ('00000000-0000-0000-0000-000000000002', 'Ocean Deep', '#1e3a5f', '#3b82f6', '#60a5fa', 0),
  ('00000000-0000-0000-0000-000000000003', 'Royal Purple', '#4c1d95', '#7c3aed', '#a78bfa', 0),
  ('00000000-0000-0000-0000-000000000004', 'Forest Emerald', '#064e3b', '#059669', '#34d399', 0),
  ('00000000-0000-0000-0000-000000000005', 'Crimson Night', '#7f1d1d', '#dc2626', '#fca5a5', 0),
  ('00000000-0000-0000-0000-000000000006', 'Midnight Galaxy', '#020617', '#1e293b', '#475569', 0),
  ('00000000-0000-0000-0000-000000000007', 'Sunset Blaze', '#7c2d12', '#ea580c', '#fdba74', 0),
  ('00000000-0000-0000-0000-000000000008', 'Cyber Pink', '#831843', '#ec4899', '#f9a8d4', 0)
